...
def _is_retryable(exc: Exception) -> bool:
    ...
    return isinstance(code, str) and code.lower() in {"rate_limit_exceeded", "server_error"}
    ...
    for tc in message.tool_calls or []:
        ...
        if tc.function.arguments:
            try:
                ...
                arguments = {}
        tool_calls.append(ToolCall(name=name, arguments=arguments, tool_call_id=tc.id or ""))
